...
export default ({
  ...
  description = "From remote designers to agile development teams, Nexlab powers collaboration for some of the most forward-thinking companies. Here's what they say:",
  textOnLeft = false,
  testimonials = [
    {
      stars: 5,
