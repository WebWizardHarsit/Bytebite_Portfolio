...
export default ({
  heading = "Smarter, Faster, and Unified Collaboration.",
  description = "Nexlab centralizes your code, tasks, and communication—so your team can move faster with clarity.",
  ...
  buttonRounded = true,
  features = ["Secure infrastructure across 7+ data regions", "Optimized for dev teams & product managers", "99.9% Uptime Guaranteed"],
  testimonial = {
    quote: "Nexlab has made remote collaboration feel effortless. The intuitive tools and clean interface help our team stay productive and in sync, no matter where we are.",
    customerName: "Ananya Rao",
    customerCompany: "PixelForge Studio."
  }
}) => {
