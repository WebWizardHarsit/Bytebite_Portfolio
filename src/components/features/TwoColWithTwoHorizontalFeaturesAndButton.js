...
export default ({
  ...
  description = "At Nexlab, we’re driven by a deep commitment to innovation, user empathy, and meaningful impact. Our philosophy centers around creating tools that empower people, not overwhelm them. Every feature is designed with intention — to simplify workflows, elevate collaboration, and inspire creativity.",
