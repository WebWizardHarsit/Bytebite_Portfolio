...
export default ({
  ...
  const defaultSteps = [
    ...
    {
      heading: "Onboard",
      description: "Import tasks, connect repos, invite your team."
    },
    {
      heading: "Run",
      description: "Collaborate in real-time and ship faster."
    }
  ];
  ...
  return (
    <Container>
      <TwoColumn>
        <ImageColumn>
          <Image src='/mockup-laptop (1).png' imageBorder={imageBorder} imageShadow={imageShadow} imageRounded={imageRounded} />
