...
// import logo from "../../images/nexlabLogo1.svg";
...
export const NavLink = styled.a(({ active }) => [
  ...
  active && tw`text-primary-500 border-primary-500`, // 👈 Highlight active link
]);
...
export default ({ roundedHeaderButton = false, logoLink, links, className, collapseBreakpointClass = "lg" }) => {
  ...
  const defaultLinks = [
    <NavLinks key={1}>
      <NavLink href="/about-us" active={currentPath === "/about-us" ? 1 : 0}>
        About
      </NavLink>
      {/* <NavLink href="/blog">Blog</NavLink>
      <NavLink href="/pricing">Pricing</NavLink> */}
      <NavLink href="/contact-us" active={currentPath === "/contact-us" ? 1 : 0}>
        Contact Us
      </NavLink>
      {/* <NavLink href="/#" tw="lg:ml-12!">
        Login
